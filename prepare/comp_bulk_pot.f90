...
program comp_bulk_pot
  ...
  do i = 1, num_press
    ...
    do j = 1, number_of_comp
      rho0(i,j) = X(j) * (rhos0/si) ! rho0, X(j) are global varies. I think rho0 here is reduced density
    ...
    write(22,*) i, pres(i), (rho0(i,j), j=1,number_of_comp), (Miu(i,j), j=1, number_of_comp), nu, errps
